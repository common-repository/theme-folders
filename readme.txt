...
Tags: categories, category, development, themes label, themes folder labeling, 
...
1. Upload 'theme-folders' folder to the `/wp-content/plugins/` directory.
...
= 0.2 = Removed icons, tested for WordPress 4.7
= 0.1 =  Initial release